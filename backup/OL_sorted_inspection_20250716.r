...
write.xlsx(COP.markers, "/mnt/workingA/BMP4_OL_sorted/results/fig1S_b_new.xlsx", rowNames = TRUE)
...
ggsave("/mnt/workingA/BMP4_OL_sorted/results/fig1S_a_new.pdf",p1s, width = 7.5, height = 7.5, units= "in" )
pdf("/mnt/workingA/BMP4_OL_sorted/results/fig1S_b_new.pdf", width = 5, height = 7.5, family = "ArialMT")
